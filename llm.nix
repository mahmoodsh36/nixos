  ...
  config = lib.mkMerge [
    (lib.mkIf config.machine.enable_nvidia {
      ...
      systemd.services.llamacpp_llm_service = {
        ...
        script = "${inputs.llama-cpp-flake.packages.${pkgs.system}.cuda}/bin/llama-server --host 0.0.0.0 --port 5000 -hf Qwen/Qwen3-14B-GGUF:Q4_K_M --jinja -ngl 99 -fa --temp 0.6 --top-k 20 --top-p 0.95 --min-p 0 --presence-penalty 1.4 -c 80000 --seed 2";
